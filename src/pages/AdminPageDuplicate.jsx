...
import styles from "./AdminPageDuplicate.module.css";
    ...
    setProjects([
      {
        ...
        students: ["Dubey Amit Radheshyam"],
        colleges: [
      ...
      },
      {
        ...
        students: ["Raj Rohit"],
        colleges: ["Birsa Institute of Technology Sindri"],
      ...
      },
      {
        ...
        project_title:
          "Study and Analysis of Viterbi Decoding Logic To Implement on FPGA",
        students: ["Yogita"],
        colleges: ["Banasthali Vidyapith"],
      ...
      },
      {
        ...
        project_title:
          "SAR Image Colorization for Comprehensive Insight Using Deep Learning Models",
        students: ["R. VARUN", "V. MOKSHYAGNA"],
        colleges: [
                          ...
                          <td>
                            {fb.remarks && fb.remarks.length > 50 ? (
                              <>
                                ...
                                >
                                  {expandedRemarks[idx] ? "View less" : "View more"}
                                </button>
                              </>
                            ) : (
                              fb.remarks
...
export default AdminPageDuplicate;
